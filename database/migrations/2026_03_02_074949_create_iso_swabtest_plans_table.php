...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('iso_swabtest_plans', function (Blueprint $table) {
            $table->id('iso_swabtest_plans_id');
            $table->date('iso_swabtest_plans_date');
            $table->integer('iso_swabtest_plans_listno');  
            $table->string('iso_swabtest_plans_area');
            $table->string('iso_swabtest_plans_list');
            $table->string('iso_swabtest_plans_qty');
            $table->string('iso_swabtest_plans_frequency');
            ...
            $table->boolean('iso_swabtest_plans_flag')->default(true);     
            $table->string('iso_swabtest_plans_person')->nullable();
            $table->string('iso_swabtest_plans_review')->nullable();
    ...
    {
        Schema::dropIfExists('iso_swabtest_plans');
    }
};
