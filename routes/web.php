...
Route::resource('/persons' , App\Http\Controllers\PersonController::class);
    ...
    Route::group([
        ...
        Route::post('/confirmDelAirtestnPlan' , [App\Http\Controllers\IsoAirtestPlanController::class , 'confirmDelAirtestnPlan']);
    });
    Route::group([
        ...
        Route::resource('/iso-swabtestplanallergen' , App\Http\Controllers\IsoSwabtestAllergenPlanController::class);
        Route::post('/iso-swabtestplanallergen/auto-update', [App\Http\Controllers\IsoSwabtestAllergenPlanController::class, 'autoUpdate'])->name('iso-swabtestplanallergen.autoupdate');
    ...
    Route::group([
        ...
        Route::post('/confirmDelMeasuringPlanFile01' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile01']);
        Route::post('/confirmDelMeasuringPlanFile02' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile02']);
        Route::post('/confirmDelMeasuringPlanFile03' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile03']);
        Route::post('/confirmDelMeasuringPlanFile04' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile04']);
        Route::post('/confirmDelMeasuringPlanFile05' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile05']);
        Route::post('/confirmDelMeasuringPlanFile06' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile06']);
        Route::post('/confirmDelMeasuringPlanFile07' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile07']);
        Route::post('/confirmDelMeasuringPlanFile08' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile08']);
        Route::post('/confirmDelMeasuringPlanFile09' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile09']);
        Route::post('/confirmDelMeasuringPlanFile10' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile10']);
        Route::post('/confirmDelMeasuringPlanFile11' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile11']);
        Route::post('/confirmDelMeasuringPlanFile12' , [App\Http\Controllers\ClbMeasuringPlanController::class , 'confirmDelMeasuringPlanFile12']);
    });
