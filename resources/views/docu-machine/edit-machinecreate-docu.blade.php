                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>ใบสร้างงาน (เลขที่ : {{$hd->machine_repair_dochd_docuno}} สถานะ : {{$hd->machine_create_status_name}})</h5>                              
                            </div>
                            <form class="custom-validation" action="{{ route('machine-create-docus.update',$hd->machine_repair_dochd_id) }}" method="POST" enctype="multipart/form-data" validate>
                            @csrf    
                            @method('PUT')  
                            <h5>รายการแจ้งสร้างงาน ผู้แจ้ง : {{$hd->person_at}}</h5>
                            <div class="card-body">
                               <div class="row"> 
                                    <div class="col-6">
                            ...
                            <h5>รายละเอียดการรับงานสร้าง</h5>
                            <div class="card-body">
                                <div class="row"> 
                                    <div class="form-group">
                                         <label class="form-label">วันที่คาดว่าจะสร้างเสร็จ</label>
                                         <input class="form-control" type="date" name="accepting_duedate" value="{{ date('Y-m-d') }}" required>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="form-group">
                                        <label class="form-label">หมายเหตุรับงานสร้าง</label>
                            ...
                            <h5>รายละเอียดการรับงานสร้าง ผู้รับงานสร้าง : {{$hd->accepting_at}} วันที่ : {{$hd->accepting_date}}</h5>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group">
                                         <label class="form-label">วันที่คาดว่าจะสร้างเสร็จ</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="machine_repair_status_id" required>
                                            ...
                                            @foreach ($status as $item)
                                               <option value="{{$item->machine_repair_status_id}}">{{$item->machine_create_status_name}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">หมายเหตุอนุมัติสร้าง</label>
                            ...
                            <div class="card-body">
                                ...
                                <h5>รายละเอียดอนุมัติสร้าง  ผู้อนุมัติสร้าง : {{$hd->approval_at}} วันที่ : {{$hd->approval_date}}</h5>
                                <div class="card-body">              
                                <div class="row">
                                     <div class="form-group">
                                        <label class="form-label">หมายเหตุอนุมัติสร้าง</label>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="form-label">วัน-เวลาที่สร้างเสร็จ</label>
                                            @php
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="repairer_type" required>
                                                <option value="ดำเนินการได้ปกติ">ดำเนินการได้ปกติ</option>
                                                <option value="หยุดการทำงาน">หยุดการทำงาน</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="repairer_problem" required>
                                                <option value="ไม่ติดปัญหา">ไม่ติดปัญหา</option>
                                                <option value="ติดเรื่องพื้นที่การทำงาน">ติดเรื่องพื้นที่การทำงาน</option>
                                                <option value="ติดเรื่องการสั่งซื้อของ">ติดเรื่องการสั่งซื้อของ</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="card ">
                                                <div class="card-body img-resize">
                                                    ...
                                                    <h5 class="fs-17 mb-2"><a href="#" class="text-dark">แนบหลักฐานการสร้าง</a></h5>                                   
                            ...
                            <h5>
                                ผลการสร้าง  ผู้สร้าง : {{$hd->repairer_at}} 
                                @if ($hd->repairer_pic1)
                            ...
                            <h5>
                                ...
                                <h5>ตรวจสอบการสร้าง ผู้ตรวจสอบ : {{$hd->inspector_at}} วันที่ : {{$hd->inspector_date}}</h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="form-label">หมายเหตุตรวจสอบ</label>
                            ...
                            <h5>
                                ...
                                <h5>ปิดงานสร้าง ผู้ปิดงาน : {{$hd->closing_at}} วันที่ : {{$hd->closing_date}}</h5>
                                    <div class="card-body"> 
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="form-label">หมายเหตุปิดงาน</label>
