                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                action="{{ route('machine-planing-docus.review-update', $dt->machine_planingdocu_dt_id) }}" 
                                method="POST" 
                                ...
                                <div class="row"> 
                                   <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="machine_planingdocu_dt_date" value="{{$dt->machine_planingdocu_dt_date}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="form-label">รหัสเครื่องจักร</label>
                                            <select class="select2 form-select" name="machine_code" disabled>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="machine_planingdocu_dt_note" value="{{$dt->machine_planingdocu_dt_note}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                        ...
                                        <tbody>
                                            @foreach ($plandt as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                       <input class="form-check-input" type="checkbox" name="machine_planing_sub_action[{{ $key }}]" value="1" checked disabled>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" type="text" name="machine_planing_sub_note[]" readonly>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="form-label">หมายเหตุ</label>
                                            <input class="form-control" type="text" name="review_remark">
                                        </div>
                                    </div>
                                </div>
                                <br>
