                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h5 class="my-0 text-primary">
                                        <a href="{{route('machine-create-docus.create')}}">
                                            เพิ่มข้อมูล
                                        </a>
                                    </h5>                  
                                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        @if ($item->machine_repair_status_id == 1 || $item->machine_repair_status_id == 9)
                                                            <span class="badge bg-warning">{{$item->machine_create_status_name}}</span>                                                           
                                                        @elseif($item->machine_repair_status_id == 7 || $item->machine_repair_status_id == 8)
                                                            <span class="badge bg-danger">{{$item->machine_create_status_name}}</span>   
                                                        @elseif($item->machine_repair_status_id == 6)
                                                            <span class="badge bg-success">{{$item->machine_create_status_name}}</span>  
                                                        @else
                                                            <span class="badge bg-secondary">{{$item->machine_create_status_name}}</span>
                                                        @endif                                                      
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if($item->machine_repair_status_id == 6)
                                                            <a href="{{ route('machine-create-docus.edit', $item->machine_repair_dochd_id) }}"class="btn btn-primary btn-sm">รายละเอียด</a>
                                                        @elseif ($item->machine_repair_status_id <> 7 || $item->machine_repair_status_id <> 8)
                                                            <a href="{{ route('machine-create-docus.edit', $item->machine_repair_dochd_id) }}"class="btn btn-warning btn-sm"><i class="bx bx-edit-alt"></i> อัพเดท</a>                                
                                                        @endif                                                      
                                                    </td>
                                                    <td>
