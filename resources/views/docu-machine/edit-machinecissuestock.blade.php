            ...
            <div class="card-header bg-transparent border-primary">
                <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            @csrf  
                            @method('PUT')    
                            <input type="hidden" value="Edit" name="reftype">
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label class="form-label">วันที่</label>
                                        <input class="form-control" type="date" name="machine_issuestock_hd_date" value="{{$hd->machine_issuestock_hd_date}}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label class="form-label">ผู้จำหน่าย</label>
                                        <input class="form-control" type="text" name="machine_issuestock_hd_vendor"  value="{{$hd->machine_issuestock_hd_vendor}}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label class="form-label">ผู้ติดต่อ</label>
                                        <input class="form-control" type="text" name="machine_issuestock_hd_contact" value="{{$hd->machine_issuestock_hd_contact}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="machine_issuestock_hd_tel" value="{{$hd->machine_issuestock_hd_tel}}">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <label class="form-label">หมายเหตุ</label>
                                        <input class="form-control" type="text" name="machine_issuestock_hd_note"  value="{{$hd->machine_issuestock_hd_note}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
function updateRowNumbers() {
    ...
    rows.forEach((row, index) => {
        let numberSpan = row.querySelector('.row-number');
        let numberHidden = row.querySelector('.row-number-hidden');

        if (numberSpan) numberSpan.textContent = index + 1;
        if (numberHidden) numberHidden.value = index + 1;
    });
}
