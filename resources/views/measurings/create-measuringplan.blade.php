                                        ...
                                        <tbody>
                                            @foreach ($clb as $key => $item)
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input class="form-control form-control-sm input-auto"oninput="this.style.height='auto';this.style.height=this.scrollHeight+'px'" name="clb_measuring_lists_frequency[]">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control form-control-sm input-auto"oninput="this.style.height='auto';this.style.height=this.scrollHeight+'px'" name="clb_measuring_lists_inside[]">
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm input-auto"oninput="this.style.height='auto';this.style.height=this.scrollHeight+'px'" name="clb_measuring_lists_external[]">
                                                    </td>
                                                    <td colspan="2">
