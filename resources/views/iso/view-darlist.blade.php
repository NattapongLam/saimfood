                                ...
                                <h5>สำหรับผู้ทบทวน</h5>
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label class="form-label">วันที่</label>
                                                <input class="form-control" type="date" name="iso_dar_lists_reviewerdate" value="{{$hd->iso_dar_lists_reviewerdate}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label class="form-label">หมายเหตุ</label>
                                                <input class="form-control" type="text" name="iso_dar_lists_reviewernote" value="{{$hd->iso_dar_lists_reviewernote}}" readonly>
                                            </div>
                                        </div>
                                    </div> 
                            </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input class="form-control" type="text" name="approved_remark" value="{{$hd->approved_remark}}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="form-label">วันที่</label>
                                                    <input class="form-control" type="date" name="approved_date" value="{{ $hd->approved_date }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                </div>
