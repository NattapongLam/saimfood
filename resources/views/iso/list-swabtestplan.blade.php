                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h5 class="my-0 text-primary">
                                        <a href="{{route('iso-swabtestplan.create')}}">
                                            เพิ่มข้อมูล
                                        </a>
                                    </h5>                  
                                </div>
                                        ...
                                        <tbody>   
                                            @foreach ($hd as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('iso-swabtestplan.edit', $item->iso_swabtest_plans_date) }}"class="btn btn-warning btn-sm"><i class="bx bx-edit-alt"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach                                      
                                        </tbody>
