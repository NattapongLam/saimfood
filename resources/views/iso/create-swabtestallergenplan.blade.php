                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>
                                        แผนการ Swab Test (Allergen)               
                                    </h5>                              
                            </div>
                            <form class="custom-validation" action="{{ route('iso-swabtestplanallergen.store') }}" method="POST" enctype="multipart/form-data" validate>
                            @csrf  
                            <div class="card-body">
                                <div class="row mt-3"> 
                                    <div class="col-3">
                                        ...
                                        <table class="table table-bordered dt-responsive nowrap w-100 text-center table-sm">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="width:10%">พื้นที่</th>
                                                    <th rowspan="2" style="width:10%">รายการ</th>
                                                    <th rowspan="2" style="width:10%">จำนวน</th>
