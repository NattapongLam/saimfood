                                ...
                                <div class="row mt-2"> 
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="iso_car_lists_docuno" value="{{$hd->iso_car_lists_docuno}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label class="form-label">กรณีออก CAR ใหม่ อ้างอิง CAR เก่าเลขที่</label>
                                            <input class="form-control" type="text" name="iso_car_lists_refno" value="{{$hd->iso_car_lists_refno}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label class="form-label">กรุณาเลือก</label>
                                            <select class="form-control" name="type_name" disabled>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="type_remark" value="{{$hd->type_remark}}" readonly>
                                        </div>
                                    </div>  
                                </div>
                                <br>
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="iso_car_lists_problem" disabled>{{$hd->iso_car_lists_problem}}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label">ผิดข้อกำหนดระบบมาตรฐานที่ :</label>
                            <input class="form-control" type="text" name="iso_car_lists_requirement" value="{{$hd->iso_car_lists_requirement}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="iso_car_lists_person" value="{{$hd->iso_car_lists_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตำแหน่ง</label>
                            <input class="form-control" type="text" name="iso_car_lists_position" value="{{$hd->iso_car_lists_position}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่</label>
                            <input class="form-control" type="date" name="iso_car_lists_date" value="{{ $hd->iso_car_lists_date }}" readonly>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="cause_person" value="{{auth()->user()->name}}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="form-label">วันที่ :</label>
                                <input class="form-control" type="date" name="cause_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                            </div>
                        </div>
                    </div>
                     <br>
                ...
                <div class="row mt-2">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="form-label">วันที่ :</label>
                                <input class="form-control" type="date" name="cause_date" value="{{$hd->cause_date }}" readonly>
                            </div>
                        </div>
                    </div>
                @endif                               
                @if ($hd->status == 2)
                 <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ผู้ออกใบแจ้งดำเนินการแก้ไข :</label>
                            <input class="form-control" type="text" name="cause_correction_person" value="{{auth()->user()->name}}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="cause_correction_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                     <br>
                ...
                @else
                 <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ผู้ออกใบแจ้งดำเนินการแก้ไข :</label>
                            <input class="form-control" type="text" name="cause_correction_person" value="{{$hd->cause_correction_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตำแหน่ง :</label>
                            <input class="form-control" type="text" name="cause_correction_position" value="{{$hd->cause_correction_position}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="cause_correction_date" value="{{ $hd->cause_correction_date }}" readonly>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cause_management_person" value="{{auth()->user()->name}}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="cause_management_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                  <br>
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตัวแทนฝ่ายบริหาร :</label>
                            <input class="form-control" type="text" name="cause_management_person" value="{{$hd->cause_management_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="cause_management_date" value="{{$hd->cause_management_date}}" readonly>
                        </div>
                    </div>
                </div>
                @endif
            ...
            <div class="card-body">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">
                                กำหนดการแก้ไข ครั้งที่ 2 เสร็จภายในวันที่
                            </label>

                            <input 
                                class="form-control"
                                type="date"
                                name="measuresone_date"
                                value="{{ $hd->measuresone_date }}"
                            >
                        </div>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ผู้รับผิดชอบการแก้ไข :</label>
                            <input class="form-control" type="text" name="measuresone_person"  value="{{auth()->user()->name}}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="measuresone_persondate" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                   <br>
                ...
                @else
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ผู้รับผิดชอบการแก้ไข :</label>
                            <input class="form-control" type="text" name="measuresone_person"  value="{{$hd->measuresone_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="measuresone_correction_person" value="{{auth()->user()->name}}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="measuresone_correction_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ผู้ติดตามผล :</label>
                            <input class="form-control" type="text" name="measuresone_correction_person" value="{{$hd->measuresone_correction_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตำแหน่ง :</label>
                            <input class="form-control" type="text" name="measuresone_correction_position" value="{{$hd->measuresone_correction_position}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="measuresone_correction_date" value="{{$hd->measuresone_correction_date}}" readonly>
                        </div>
                    </div>
                </div>
                @endif             
                @if ($hd->status == 6)  
                 <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตัวแทนฝ่ายบริหาร :</label>
                            <input class="form-control" type="text" name="measuresone_management_person" value="{{auth()->user()->name}}">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="measuresone_management_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                 <br>
                ...
                @else  
                 <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตัวแทนฝ่ายบริหาร :</label>
                            <input class="form-control" type="text" name="measuresone_management_person" value="{{$hd->measuresone_management_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="measuresone_management_date" value="{{$hd->measuresone_management_date}}" readonly>
                        </div>
                    </div>
                </div>
                @endif 
                @if ($hd->measuresone_next)  
            ...
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตัวแทนฝ่ายบริหาร :</label>
                            <input class="form-control" type="text" name="car_management_person" value="{{auth()->user()->name}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="car_management_date" value="{{ old('iso_dar_lists_date', date('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
                   <br>
                ...
                @else
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">CAR NO :</label>
                            <input class="form-control" type="text" name="new_docuno" value="{{$hd->new_docuno}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label">หมายเหตุ :</label>
                            <textarea class="form-control" name="car_remark" disabled>{{$hd->car_remark}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">ตัวแทนฝ่ายบริหาร :</label>
                            <input class="form-control" type="text" name="car_management_person" value="{{$hd->car_management_person}}" readonly>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label class="form-label">วันที่ :</label>
                            <input class="form-control" type="date" name="car_management_date" value="{{$hd->car_management_date}}" readonly>
                        </div>
                    </div>
                </div>
                @endif                
