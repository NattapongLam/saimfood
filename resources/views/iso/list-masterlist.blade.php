                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h5 class="my-0 text-primary">
                                        <a href="{{route('iso-masterlist.create')}}">
                                            เพิ่มข้อมูล
                                        </a>
                                    </h5>                  
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($hd as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('iso-masterlist.edit', $item->iso_master_lists_id) }}"class="btn btn-warning btn-sm"><i class="bx bx-edit-alt"></i></a>
                                                    </td>
                                                    <td>
                                                         <a href="javascript:void(0)" class="btn btn-danger btn-sm" onclick="confirmDel('{{ $item->iso_master_lists_id }}')"><i class="fas fa-trash"></i></a>    
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
