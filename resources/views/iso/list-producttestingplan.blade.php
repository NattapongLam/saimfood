                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h5 class="my-0 text-primary">
                                        <a href="{{route('iso-producttestingplan.create')}}">
                                            เพิ่มข้อมูล
                                        </a>
                                    </h5>                  
                                </div>
                                ...
                                <div class="row"> 
                                    <table id="DataTableList" class="table table-bordered dt-responsive nowrap w-100 text-center table-sm">
                                        ...
                                        <tbody>   
                                            @foreach ($hd as $item)
                                                <tr>
                                                    <td>{{$item->iso_product_testing_plans_date}}</td>
                                                    <td>
                                                        <a href="{{ route('iso-producttestingplan.edit', $item->iso_product_testing_plans_date) }}"class="btn btn-warning btn-sm"><i class="bx bx-edit-alt"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach                                      
                                        </tbody>
