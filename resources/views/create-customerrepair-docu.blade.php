                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="equipment_transfer_hd_docuno" type="date" value="{{$hd->equipment_transfer_hd_date}}" readonly>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="customer_fullname" type="text" value="{{$hd->customer_fullname}}" readonly>
                                    <input type="hidden" name="customer_id" value="{{$hd->customer_id}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-label">ที่อยู่จัดส่ง</label>
                                    <input class="form-control" name="customer_address" type="text" value="{{$hd->customer_address}}" readonly>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="equipment_code" type="text" value="{{$dt->equipment_code}}" readonly>
                                    <input type="hidden" name="equipment_id" value="{{$dt->equipment_id}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-label">ชื่อเครื่อง</label>
                                    <input class="form-control" name="equipment_name" type="text" value="{{$dt->equipment_name}}" readonly>
                                </div>
                            </div>
                        </div>
                        <br>
