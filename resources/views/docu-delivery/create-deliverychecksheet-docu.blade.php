            ...
            <div class="card-header bg-transparent border-primary">
                <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                <form class="custom-validation" action="{{ route('delivery-checksheet-docus.store') }}" method="POST" enctype="multipart/form-data" validate>
                                @csrf      
                                <div class="row"> 
                                    <div class="col-6">
...
$(document).ready(function () {
    ...
    $('#machineSelect').on('change', function () {
        ...
        if (id) {
            $.ajax({
                url: `/get-delivery-checkdetails/${id}`,
                type: 'GET',
