            ...
            <div class="card-header bg-transparent border-primary">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <form class="custom-validation" action="{{ route('delivery-checksheet-docus.update', $hd->machine_checksheet_docu_hd_id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
...
confirmApproved = (refid, day) => {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: `{{ url('/confirmApprovedDeliveryChecksheetDocuHd') }}`,
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "refid": refid,
