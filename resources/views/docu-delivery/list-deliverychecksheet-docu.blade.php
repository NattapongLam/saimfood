                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <h5 class="my-0 text-primary">
                                        <a href="{{route('delivery-checksheet-docus.create')}}">
                                            เพิ่มข้อมูล
                                        </a>
                                    </h5>                  
                                </div>
                                            ...
                                            @foreach ($hd as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <a href="{{ route('delivery-checksheet-docus.edit', $item->machine_checksheet_docu_hd_id) }}"class="btn btn-warning btn-sm"><i class="bx bx-edit-alt"></i> อัพเดท</a>                                                                                                                  
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('delivery-checksheet-docus.print', $item->machine_checksheet_docu_hd_id) }}"class="btn btn-info btn-sm"><i class="bx bx-task"></i> เอกสาร</a>                                                                                                          
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
...
Swal.fire({
    ...
    if (result.value) {
        $.ajax({
            url: `{{ url('/confirmDelDeliveryChecksheetDocuHd') }}`,
            type: "POST",
            data: {
                "_token": "{{ csrf_token() }}",
                "refid": refid,               
