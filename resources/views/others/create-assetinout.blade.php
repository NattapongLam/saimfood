        ...
        <div class="card">
            <div class="card-header bg-transparent border-primary">
                <div class="row">
                        ...
                        <div class="card-body">
                            <form class="custom-validation" action="{{ route('asset-inout.store') }}" method="POST" enctype="multipart/form-data" validate>
                            @csrf 
                            <div class="row">
                                <div class="col-3">
                                    <label class="form-label">วันที่</label>
                                    <input class="form-control" type="date" name="assetinout_hd_date" value="{{ date('Y-m-d') }}">
                                </div>
                                <div class="col-3">
                                    <label class="form-label">เลขที่</label>
                                    <input class="form-control" type="text" name="assetinout_hd_docuno" value="{{$docs}}" readonly>
                                    <input type="hidden" name="assetinout_hd_docunum" value="{{$docs_number}}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">คู่ค้า</label>
                                    <input class="form-control" type="text" name="assetinout_hd_vendor" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <label class="form-label">ผู้ติดต่อ</label>
                                    <input class="form-control" type="text" name="assetinout_hd_contact">
                                </div>
                                <div class="col-3">
                                    <label class="form-label">เบอร์โทร</label>
                                    <input class="form-control" type="text" name="assetinout_hd_tel">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">หมายเหตุ</label>
                                    <input class="form-control" type="text" name="assetinout_hd_note">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
