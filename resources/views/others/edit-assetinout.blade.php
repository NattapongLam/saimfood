                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" name="assetinout_hd_vendor" value="{{$hd->assetinout_hd_vendor}}"  required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <label class="form-label">ผู้ติดต่อ</label>
                                    <input class="form-control" type="text" name="assetinout_hd_contact" value="{{$hd->assetinout_hd_contact}}">
                                </div>
                                <div class="col-3">
                                    <label class="form-label">เบอร์โทร</label>
                                    <input class="form-control" type="text" name="assetinout_hd_tel" value="{{$hd->assetinout_hd_tel}}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">หมายเหตุ</label>
                                    <input class="form-control" type="text" name="assetinout_hd_note" value="{{$hd->assetinout_hd_note}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                                ...
                                                <tbody>
                                                    @foreach ($dt as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control" name="assetinout_dt_name[]" value="{{$item->assetinout_dt_name}}">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" name="assetinout_dt_qty[]" value="{{$item->assetinout_dt_qty}}">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" name="assetinout_dt_note[]" value="{{$item->assetinout_dt_note}}">
                                                            </td>
                                                            <td>
