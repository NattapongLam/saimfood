                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="customer_fullname" id="customer_fullname" type="hidden" value="{{$hd->customer_fullname}}" required>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="customer_transfer_status_id" id="customer_transfer_status_id" required>
                                            @foreach ($sta as $item)
                                ...
                                <div class="col-9">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="approved_remark" id="approved_remark">
                                    </div>
                                </div>
                            </div>
                            <br>
