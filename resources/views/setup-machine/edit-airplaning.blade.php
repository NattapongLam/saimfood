            ...
            <div class="card-header bg-transparent border-primary">
                <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="row">  
                                    <form class="custom-validation" action="{{ route('air-planings.update',$hd->machine_planing_hd_id) }}" method="POST" enctype="multipart/form-data" validate>
                                    @csrf
                                    @method('PUT')                                      
                                    <div class="col-12"> 
                                        <div class="row">
